...
.principal-grid {
    ...
    border-radius: 24px;
    overflow: hidden;
    box-shadow: 0 15px 45px rgba(43, 20, 13, 0.14);
}
...
#boton {
    ...
    font-weight: 600;
    text-decoration: none;
    box-shadow: 0 6px 18px rgba(11,168,74,0.22);
    transition: 0.3s ease;
}
...
#boton:hover {
    background: #098d3e;
    transform: translateY(-2px);
    box-shadow: 0 9px 22px rgba(11,168,74,0.30);
}
...
tbody td img {
    ...
    box-shadow: 0 4px 12px rgba(43,20,13,0.10);
    transition: 0.3s ease;
}
...
.btn-editar:hover {
    ...
    color: white;
    transform: translateY(-2px);
    box-shadow: 0 5px 12px rgba(43,20,13,0.20);
}
...
.btn-eliminar:hover {
    ...
    color: white;
    transform: translateY(-2px);
    box-shadow: 0 5px 12px rgba(150,58,42,0.20);
}
...
.btn-mostrar:hover {
    ...
    color: white;
    transform: translateY(-2px);
    box-shadow: 0 5px 12px rgba(11,168,74,0.25);
}
...
Swal.fire({
    ...
    html: "Estos productos necesitan reposición:<br><br><strong><?= implode('<br>', $productosBajoStock) ?></strong>",
    icon: "warning",
